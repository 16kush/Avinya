...
AlertError(alertmsg, alertType) {
    ...
    render(){
        ...
        if (this.state.redirect) {
            ...
            if(this.state.Courses["Development"].touched){
                webdev = ['touched']
            }
            else{
                webdev=['']
            ...
            if(this.state.Courses["Designing"].touched){
        ...
        <Layout>
            ...
            <div className="container">
                ...
                <div className="Preference-buttons">
                    ...
                    <button className={webdev.join(' ')} onClick={()=> this.categoryHandler("Development")}> Development</button>
                    <button className={webdesigning.join(' ')} onClick={()=> this.categoryHandler("Designing")}> Designing</button>
