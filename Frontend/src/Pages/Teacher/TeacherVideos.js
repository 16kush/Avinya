...
class TeacherPage extends Component {
	...
	OverallValidity = () => {
		if (
			this.state.Form.file.valid1 ||
			this.state.Form.file.valid2 ||
			this.state.Form.file.valid3 ||
			this.state.Form.file.valid4 ||
			this.state.Form.file.valid5
		)
			return true;
		else return false;
	};
	...
	sumbitButton = () => {
		...
		if (this.OverallValidity()) {
			axios
				.post(
					`/creator/videoUpload/${this.props.location.state.CourseId}`,
					fd,
					{
					...
					<div className='Teacher-Head-ClassVideo'>
						<label className='videoUpload'>
							<input
								...
								onChange={(event) => {
									this.fileSelectorHandler(event, 1);
								}}
							/>
							Upload Video 1
						</label>
					...
					<div className='Teacher-Head-ClassVideo'>
						<label className='videoUpload'>
							<input
								...
								accept='video/mp4, video/mov'
								onChange={(event) => {
									this.fileSelectorHandler(event, 2);
								}}
							/>
							Upload Video 2
						</label>
					...
					<div className='Teacher-Head-ClassVideo'>
						<label className='videoUpload'>
							<input
								...
								accept='video/mp4, video/mov'
								onChange={(event) => {
									this.fileSelectorHandler(event, 3);
								}}
							/>
							Upload Video 3
						</label>
					...
					<div className='Teacher-Head-ClassVideo'>
						<label className='videoUpload'>
							<input
								...
								accept='video/mp4, video/mov'
								onChange={(event) => {
									this.fileSelectorHandler(event, 4);
								}}
							/>
							Upload Video 4
						</label>
					...
					<div className='Teacher-Head-ClassVideo'>
						<label className='videoUpload'>
							<input
								...
								accept='video/mp4, video/mov'
								onChange={(event) => {
									this.fileSelectorHandler(event, 5);
								}}
							/>
							Upload Video 5
						</label>
